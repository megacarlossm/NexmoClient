 ...
 * @param {string} params.iceGatherOnlyOneCandidate=false the flag for gathering one candidate or multiple in rtc ice gathering process
 *
...
export interface Configuration {
  ...
  token?: string | null;
  iceGatherOnlyOneCandidate?: boolean;
  [key: string]: any;
}
